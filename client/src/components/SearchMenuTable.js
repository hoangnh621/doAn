...
import '../scss/SearchMenuTable.scss'
...
const SearchMenuTable = () => {
    ...
    const handleQuantityFood = (valueQuantityFood, data) => {
        setDataRep(prev => {
    ...
    return (
            <div className = "d-flex search-food-table searchMenuTable">
...
export default SearchMenuTable
